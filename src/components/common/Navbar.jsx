...
function Navbar() {
  ...
  return (
    <div className="w-full">
      ...
      {/* top section */}
      <div className="h-[calc(100vh-50px)] bg-red-500 flex flex-col gap-y-6 items-center justify-center text-4xl background w-full mx-auto" id="top-section">
      ...
      <div>
        ...
        <div className="pt-[80px]" id="team">
          <Testimonial />
        </div>

        <div className="mt-[80px] pb-[150px] bg-blue-400" id="contact">
          <Contact />
        </div>
